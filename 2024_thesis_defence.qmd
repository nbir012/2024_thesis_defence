...
::: notes
-   when we compare this to a count of companies that used these words
-   we see that sustainable and protein are used by every single company
...
-   620 participants
-   367 had eaten insects (59.2%)
-   471 participants were likely to eat in future (76.0%)
-   498 people could name one or more species (80.3%)
-   333 people named the huhu grub (53.7%)
-   298 people named crickets (48.1%)

::: notes
This reflects the widely known status of huhu grubs in New Zealand The international and local recognition of crickets (e.g. cricket flour)
:::
...
![](media/c_3/sent_analysis.png){width="1200"}
...
-   becomes interesting when looking at individual ingredients
-   Cricket flour is actually has very positive sentiment scores
-   huhu grubs are broadly comparable to lamb and tofu
-   words with "worm" or "pupae" in them ellicit greater disgust
:::
...
-   Sustainability/environmental impact is a selling point for edible insects
...
::: {.column .fragment width="33%"}
<video data-autoplay src="media/c_5/flightmill_huhu_v2.mp4">
...
::: columns
::: {.column width="40%"}
![](media/c_5/flightmill_huhu_staple.jpg)
:::

::: {.column width="60%"}
![](media/c_5/flightmill_huhu_staple_close.png)
:::
:::
...
-   distance and duration had excellent fit (r2)
...
## The Ghiselin – Reiss small-male hypothesis

<briefly run through this with visual aids>
